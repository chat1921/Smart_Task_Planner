...
Here is the complete, fixed README.md code. I have repaired the broken code blocks so that every step (1, 2, 3, etc.) will appear correctly separated on GitHub.

Copy the entire block below and paste it into your GitHub file.
Markdown
